...
const ContestInfo = (props) => {
  ...
  return (
    < div;
  className = { styles.mainContestInfoContainer } >
    < div;
  className = { styles.infoContainer } >
    < div;
  className = { styles.contestTypeContainer } >
    < div;
  className = { styles.dataContainer } >
    < span;
  className = { styles.label } > Contest;
  Type < /span>
  < span;
  className = { styles.data } > { contestType } < /span>
    < /div>;
  {
...
<
  ...
  Project < /span>
  < span;
  className = { styles.data } > { title } < /span>
    < /div>;
  {
...
<
  /span>
  < span;
  className = { styles.data } > { focusOfWork } < /span>
    < /div>
    < div;
  className = { styles.dataContainer } >
    < span;
  ...
  company < /span>
  < span;
  className = { styles.data } > { targetCustomer } < /span>
    < /div>
    < div;
  className = { styles.dataContainer } >
    < span;
  className = { styles.label } > Industry;
  of;
  company < /span>
  < span;
  className = { styles.data } > { industry } < /span>
    < /div>;
  {
    originalFileName && < div;
    className = { styles.dataContainer } >
      < span;
    className = { styles.label } > Additional;
    File < /span>
    < a;
    target = '_blank';
