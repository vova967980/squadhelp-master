...
const ContestBox = (props) => {
  ...
  const getTimeStr = () => {
    const diff = ( moment.duration(
      moment().diff(moment(props.data.createdAt))) );
    let str = '';
  ...
  onClick = {();
=>
  props.goToExtended(id);
}>
<
  div;
  className = { styles.mainContestInfo } >
    < div;
  className = { styles.titleAndIdContainer } >
    < span;
  className = { styles.title } > { title } < /span>
    < span;
  className = { styles.id } > {`(#${ id })`;
}<
  /span>
  < /div>
  < div;
  className = { styles.contestType } >
    < span > {`${ ucFirstLetter(contestType) } / ${ getPreferenceContest() }`;
}<
  /span>
  < /div>
  < div;
  ...
  className = { styles.prizeContainer } >
    < div;
  className = { styles.guaranteedContainer } >
    < div >
    < img;
  ...
  < /div>
  < div;
  className = { styles.entryAndTimeContainer } >
    < div;
  className = { styles.entriesContainer } >
    < div;
  className = { styles.entriesCounter } >
    < img;
  ...
  className = { styles.timeContainer } >
    < span;
  className = { styles.timeContest } > { getTimeStr () } < /span>
    < span > Going < /span>
    < /div>
    < /div>
    < /div>
