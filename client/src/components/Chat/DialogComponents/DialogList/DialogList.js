...
const DialogList = (props) => {
  ...
  const renderPreview = (filterFunc) => {
    ...
    <
      ...
      chatMode = { chatMode };
      catalogOperation = { chatMode === CONSTANTS.CATALOG_PREVIEW_CHAT_MODE
        ? removeChat
    ...
    return arrayList.length ? arrayList :
  <
    span;
    className = { styles.notFound } > Not;
    found < /span>;;
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    changeShowAddChatToCatalogMenu: (data) => dispatch(
