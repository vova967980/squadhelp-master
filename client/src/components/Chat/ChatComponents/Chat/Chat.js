  ...
  renderDialogList = () => {
  ...
  }
    {
        ...
        < /div>};
      {
        ...
        onClick = {();
      =>
        setChatPreviewMode(NORMAL_PREVIEW_CHAT_MODE);
      }
        ...
        onClick = {();
      =>
        setChatPreviewMode(FAVORITE_PREVIEW_CHAT_MODE);
      }
        className = { classNames (styles.button
        {
          [styles.activeButton];
        ...
        onClick = {();
      =>
        setChatPreviewMode(BLOCKED_PREVIEW_CHAT_MODE);
      }
        className = { classNames (styles.button
        {
          [styles.activeButton];
        ...
        onClick = {();
      =>
        setChatPreviewMode(CATALOG_PREVIEW_CHAT_MODE);
      }
        className = { classNames (styles.button
        {
          [styles.activeButton];
