...
<
  ...
  className = { styles.infoBlock } >
    < span;
  className = { styles.label } > First;
  Name < /span>
  < span;
  className = { styles.info } > { firstName } < /span>
    < /div>
    < div;
  className = { styles.infoBlock } >
    < span;
  ...
  Name < /span>
  < span;
  className = { styles.info } > { lastName } < /span>
    < /div>
    < div;
  className = { styles.infoBlock } >
    < span;
  className = { styles.label } > Display;
  Name < /span>
  < span;
  className = { styles.info } > { displayName } < /span>
    < /div>
    < div;
  className = { styles.infoBlock } >
    < span;
  className = { styles.label } > Email < /span>
    < span;
  className = { styles.info } > { email } < /span>
    < /div>
    < div;
  className = { styles.infoBlock } >
    < span;
  className = { styles.label } > Role < /span>
    < span;
  className = { styles.info } > { role } < /span>
    < /div>;
  {
    role === CONSTANTS.CREATOR && < div;
    className = { styles.infoBlock } >
      < span;
    className = { styles.label } > Balance < /span>
      < span;
    className = { styles.info } > {`${ balance }$`;
  }<
    /span>
    < /div>}
    < /div>
