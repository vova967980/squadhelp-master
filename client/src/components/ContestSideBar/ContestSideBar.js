...
const ContestSideBar = (props) => {
  ...
  const renderContestInfo = () => {
    ...
    return (
      < div;
    className = { styles.contestSideBarInfo } >
      < div;
    className = { styles.contestInfo } >
      < div;
    className = { styles.awardAndTimeContainer } >
      < div;
    ...
    alt = 'clock' / >
      ...
      < /div>
      < span;
    className = { styles.time } > { getTimeStr () } < /span>
      < /div>
      < div;
    className = { styles.guaranteedPrize } >
      < div >
      < img;
    ...
    < /div>
    < div;
    className = { styles.contestStats } >
      < span > Contest;
    Stats < /span>
    < div;
    className = { styles.totalEntrie } >
      < span;
    className = { styles.totalEntriesLabel } > Total;
    Entries < /span>
    ...
    < /div>;
    {
      props.data.id !== User.id && < div;
      className = { styles.infoCustomerContainer } >
        < span;
      className = { styles.labelCustomerInfo } > About;
      Contest;
      Holder < /span>
      < div;
      ...
      alt = 'user' / >
        < div;
      className = { styles.customerNameContainer } >
