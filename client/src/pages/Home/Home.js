...
const Home = (props) => {
  ...
  const text = CONSTANTS.HEADER_ANIMATION_TEXT[ index %
  CONSTANTS.HEADER_ANIMATION_TEXT.length ];
  return (
    < >
    < Header / >
    { isFetching ? < Spinner / >
:
  ...
  className = { styles.container__description } >
    < h2;
  className = { styles.blueUnderline } > Why;
  Squadhelp ?
<
  /h2>
  < div;
  ...
  from;
  world;
  's largest community of naming experts.
  With;
  75, 000 + creatives;
  and;
  15, 000 + successful;
  ...
  Features < /h3>
  < p > Squadhelp;
  's high end Audience Testing service allows you to poll your target
  demographics;
  to;
  get;
  unbiased;
...
:
  ...
  Sale < /h3>
  < p;
  className = { styles.blueUnderline } > Not;
  ...
  to = '/dashboard' > DASHBOARD < /Link>
    < /div>
    < div;
  className = { styles.blueContainer } >
    < h2;
  className = { styles.whiteUnderline } > What;
  our;
  customers;
  say < /h2>
  < SlideBar;
