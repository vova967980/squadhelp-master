...
class ContestPage extends React.Component{
  ...
  <
    div;
    className = { styles.notFound } > There;
    is;
    no;
    suggestion;
    at;
  ...
  needButtons = (offerStatus) => {
    ...
    return ( contestCreatorId === userId && contestStatus ===
      CONSTANTS.CONTEST_STATUS_ACTIVE && offerStatus ===
  ...
  render () {
    ...
    =>
      ...
      < Header / >
      { error ? < div;
      className = { styles.tryContainer } > < TryAgain;
      getData = { getData };
      /></;
      div >
    :
      (
        isFetching ?
      < div;
      className = { styles.containerSpinner } >
        < Spinner / >
        < /div>;
    :
      ( < div;
    ...
    =>
      ...
      <
        ...
        className = { styles.offersContainer } >
          {(role === CONSTANTS.CREATOR && contestData.status ===
