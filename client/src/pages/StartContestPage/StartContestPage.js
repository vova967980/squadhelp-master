        ...
        <div>
            ...
            <div className={styles.baseBundleContainer}>
                <div className={styles.infoBaseBundles}>
                    <span className={styles.headerInfo}>Our Most Popular <span>Categories</span></span>
                ...
                <div className={styles.baseBundles}>
                    <BundleBox path={['Name.png']} header='Name' describe='Get up and running with the perfect name.'
                               setBundle={setBundle}/>
                    <BundleBox path={['Logo.png']} header='Logo'
                               describe='Kickstart your venture with a unique, memorable logo.'
                               setBundle={setBundle}/>
                    <BundleBox path={['Tagline.png']} header='Tagline'
            ...
            <div className={styles.combinedBundles}>
                ...
                <div className={styles.baseBundles}>
                    <BundleBox path={['Name.png', 'Logo.png']} header='Name+Logo'
                               describe='Get the essentials needed to establish your brand together and save.'
                               setBundle={setBundle}/>
                    <BundleBox path={['Name.png', 'Tagline.png']} header='Name+Tagline'
                               describe='Communicate your vision with the perfect Name/Tagline combo.'
                               setBundle={setBundle}/>
                    <BundleBox path={['Logo.png', 'Tagline.png']} header='Tagline+Logo'
                               describe='Description for Logo + Tagline will come here.' setBundle={setBundle}/>
                    <BundleBox path={['Name.png', 'Logo.png', 'Tagline.png']} header='Name+Tagline+Logo'
